...
const API_ORDERS = "https://1qvyjv74r3.execute-api.us-east-1.amazonaws.com/dev";
const API_FULFILL = "https://gc8sncxhie.execute-api.us-east-1.amazonaws.com/dev";
const API_STATUS = "https://93icxxrllb.execute-api.us-east-1.amazonaws.com/dev";
const getTenantHeaders = (tenantId = "CHINAWOK_LIMA_CENTRO")=>({
        "Content-Type": "application/json",
        "x-tenant-id": tenantId
    });
}),
"[project]/lib/services/orders-service.ts [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const ordersService = {
    ...
    async getOrdersByCustomer (customerId, tenantId) {
        const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_ORDERS"]}/orders/customer/${customerId}`, {
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getTenantHeaders"])(tenantId)
        });
        return res.json();
    },
    async getOrderById (orderId, tenantId) {
        const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_ORDERS"]}/orders/${orderId}`, {
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getTenantHeaders"])(tenantId)
        });
        return res.json();
    },
    async cancelOrder (orderId, cancelledBy, reason, tenantId) {
        const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_ORDERS"]}/orders/${orderId}/cancel`, {
            method: "PATCH",
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getTenantHeaders"])(tenantId),
            body: JSON.stringify({
    ...
    async getOrdersByStatus (status, tenantId) {
        const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["API_ORDERS"]}/orders?status=${status}`, {
            headers: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getTenantHeaders"])(tenantId)
        });
        return res.json();
    }
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$context$2f$cart$2d$context$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/context/cart-context.tsx [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$orders$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/services/orders-service.ts [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$context$2f$tenant$2d$context$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/context/tenant-context.tsx [app-ssr] (ecmascript)");
...
function CheckoutPage() {
    ...
    const { items, total, clearCart } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$context$2f$cart$2d$context$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useCart"])();
    const { customerId } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$context$2f$tenant$2d$context$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useTenant"])();
    ...
    const handleSubmit = async (e)=>{
        ...
        try {
            ...
            const response = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$services$2f$orders$2d$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ordersService"].createOrder(orderData);
                                            ...
                                            children: [
                                                ...
                                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                            className: deliveryFee === 0 ? "text-cw-green font-semibold" : "",
                                                            children: deliveryFee === 0 ? "Gratis" : `S/ ${deliveryFee.toFixed(2)}`
                                                        }, void 0, false, {
                                                            fileName: "[project]/app/checkout/page.tsx",
                                                            lineNumber: 217,
                                                            columnNumber: 19
...
//# sourceMappingURL=%5Broot-of-the-server%5D__df868254._.js.map